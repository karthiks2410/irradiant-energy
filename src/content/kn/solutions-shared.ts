...
export const solutionsShared = {
  hub: {
    meta: {
      ...
      description: "ಕರ್ನಾಟಕದಾದ್ಯಂತ ಮನೆ, ಅಪಾರ್ಟ್\u200cಮೆಂಟ್ ಮತ್ತು ವ್ಯಾಪಾರ ಕಟ್ಟಡಗಳ ಚಾವಣಿ ಮೇಲೆ ಸೋಲಾರ್. ಕೆಲಸ ಹೇಗೆ ನಡೆಯುತ್ತದೆ, ಯಾವ ವ್ಯವಸ್ಥೆ ಸೂಕ್ತ ಎಂದು ನೋಡಲು ನಿಮ್ಮ ವಿಭಾಗ ಆಯ್ಕೆ ಮಾಡಿ.",
    },
    breadcrumb: "ಸೇವೆಗಳು",
    ...
    items: [
      {
        ...
        plainDescription: "ನಿಮ್ಮ ಛಾವಣಿಯ ವಿದ್ಯುತ್ ಮನೆಗೆ ಬಳಕೆಯಾಗುತ್ತದೆ; ಹೆಚ್ಚುವರಿ ವಿದ್ಯುತ್ ಗ್ರಿಡ್\u200cಗೆ ಹೋಗಿ ಬಿಲ್\u200cನಲ್ಲಿ ಜಮಾ ಆಗುತ್ತದೆ. ಸ್ಥಿರ ವಿದ್ಯುತ್ ಪೂರೈಕೆ ಇರುವ ಮನೆಗಳಿಗೆ ಹೆಚ್ಚು ಜನಪ್ರಿಯ.",
      },
      {
        label: "ಆಫ್-ಗ್ರಿಡ್",
        plainName: "ಬ್ಯಾಟರಿಯೊಂದಿಗೆ ಸಂಪೂರ್ಣ ಸ್ವತಂತ್ರರಾಗಿ",
        description: "Independent system with battery backup",
        plainDescription: "ನಿಮ್ಮ ಛಾವಣಿ ಮತ್ತು ಬ್ಯಾಟರಿ ಪ್ಯಾಕ್. ಕರೆಂಟ್ ಹೋದಾಗಲೂ ಗ್ರಿಡ್ ಮೇಲೆ ಅವಲಂಬನೆ ಇಲ್ಲವೇ ಇಲ್ಲ. ವಿದ್ಯುತ್ ಸರಿಯಾಗಿ ಬರದ ಕಡೆ ಅಥವಾ ದೂರದ ಜಾಗಗಳಿಗೆ ಸೂಕ್ತ.",
      },
      {
        label: "ಹೈಬ್ರಿಡ್",
        plainName: "ಎರಡರ ಒಳ್ಳೆಯದೂ ಒಟ್ಟಿಗೆ — ವಿದ್ಯುತ್ ಮತ್ತು ಬ್ಯಾಕಪ್",
        description: "Best of both - grid + battery storage",
        plainDescription: "ಹಗಲಿನಲ್ಲಿ ಸೋಲಾರ್ ವಿದ್ಯುತ್ ಬಳಸಿ, ಹೆಚ್ಚುವರಿಯನ್ನು ಬ್ಯಾಟರಿಯಲ್ಲಿ ಸಂಗ್ರಹಿಸಿ, ಅಗತ್ಯವಿದ್ದಾಗ ಮಾತ್ರ ಗ್ರಿಡ್\u200cನಿಂದ ವಿದ್ಯುತ್ ಪಡೆಯಿರಿ. ಇದು ಅತ್ಯಂತ ವಿಶ್ವಾಸಾರ್ಹ ಆಯ್ಕೆ.",
      },
    ],
  },
  closingCta: {
  ...
  whatsappPrompts: {
    home: {
      text: "ನಮಸ್ಕಾರ! ಮನೆಯ ಸೋಲಾರ್ ಬಗ್ಗೆ ನನಗೊಂದು ಪ್ರಶ್ನೆ ಇದೆ — ಸಹಾಯ ಮಾಡುವಿರಾ?",
    },
    "housing-society": {
      text: "ನಮಸ್ಕಾರ! ನಮ್ಮ ಸಂಘ ಚಾವಣಿ ಮೇಲೆ ಸೋಲಾರ್ ಬಗ್ಗೆ ಯೋಚಿಸುತ್ತಿದೆ — ವಾರ್ಷಿಕ ಮಹಾಸಭೆಯಲ್ಲಿ ಮಂಡಿಸಬಹುದಾದ ಪ್ರಸ್ತಾವನೆ ಕಳುಹಿಸಿಕೊಡುವಿರಾ?",
    },
    commercial: {
      text: "ನಮಸ್ಕಾರ! ನಾವು ಒಂದು ವ್ಯಾಪಾರ ಸಂಸ್ಥೆ; ಚಾವಣಿ ಮೇಲೆ ಸೋಲಾರ್ ಬಗ್ಗೆ ಯೋಚಿಸುತ್ತಿದ್ದೇವೆ — ನಮ್ಮ ಕಟ್ಟಡಕ್ಕೆ CAPEX ಮತ್ತು OPEX ಹೋಲಿಕೆ ಕಳುಹಿಸಿಕೊಡುವಿರಾ?",
    },
  },
