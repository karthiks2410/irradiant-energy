...
export const solutionsShared = {
  hub: {
    meta: {
      ...
      description: "ಬೆಂಗಳೂರು ಮತ್ತು ಕರ್ನಾಟಕದಾದ್ಯಂತ ಮನೆ, ಅಪಾರ್ಟ್\u200cಮೆಂಟ್ ಮತ್ತು ವ್ಯಾಪಾರ ಕಟ್ಟಡಗಳ ಚಾವಣಿ ಮೇಲೆ ಸೋಲಾರ್. ಕೆಲಸ ಹೇಗೆ ನಡೆಯುತ್ತದೆ, ನಿಮಗೆ ಯಾವ ವ್ಯವಸ್ಥೆ ಸೂಕ್ತ ಎಂದು ನೋಡಿ.",
    },
    breadcrumb: "ಸೇವೆಗಳು",
